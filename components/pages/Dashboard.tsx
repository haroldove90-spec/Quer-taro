          ...
          <CardContent>
            <ul className="space-y-4">
              {announcements.slice(0, 3).map(ann => (
                <li key={ann.id} className="p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
          ...
          <CardContent>
            <ul className="space-y-4">
              {amenityBookings.slice(0,3).map(booking => (
                <li key={booking.id} className="flex justify-between items-center p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                  <div>
