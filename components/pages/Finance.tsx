...
import { transactions, properties, owners, expenses } from '../../data/mockData';
  ...
  return (
    <div className="p-4 sm:p-6 space-y-6">
       <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        <StatCard title="Ingresos Totales" value={formatCurrency(totalIncome)} icon={ICONS.finance} helpText="Suma de todos los pagos recibidos." />
        <StatCard title="Cuentas por Cobrar" value={formatCurrency(accountsReceivable)} icon={ICONS.notification} helpText="Suma de pagos pendientes y vencidos." />
        ...
        <StatCard title="Balance Neto" value={formatCurrency(netBalance)} icon={ICONS.dashboard} helpText="Ingresos menos gastos." />
      </div>

      <Card>
        <div className="flex justify-between items-center mb-4">
            <CardTitle>Historial de Transacciones</CardTitle>
            <Button leftIcon={ICONS.plus}>Registrar Pago</Button>
        </div>
        <CardContent>
